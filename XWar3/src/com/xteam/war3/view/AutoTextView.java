...
public class AutoTextView extends TextView{ 
	...
	public AutoTextView(Context context, float textSize, int textColor, float paddingLeft, float paddingRight, float marginLeft, float marginRight){ 
		super(context); 
	...
	protected void onDraw(Canvas canvas) { 
		...
		for (int i = 0; i < textCharArray.length; i++) { 
			...
			if(textCharArray[i] > 127 && textCharArray[i] != '、' && textCharArray[i] != '，' 
					&& textCharArray[i] != '。' && textCharArray[i] != '：' && textCharArray[i] != '！'){ 
